...
"""autogenerated by genpy from action_server/defActionResult.msg. Do not edit."""
import codecs
import sys
...
class defActionResult(genpy.Message):
  ...
  _type = "action_server/defActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_server/defResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = action_server.msg.defResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = action_server.msg.defResult()
