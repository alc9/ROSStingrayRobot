...
"""autogenerated by genpy from action_server/defActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class defActionFeedback(genpy.Message):
  ...
  _type = "action_server/defActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_server/defFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = action_server.msg.defFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = action_server.msg.defFeedback()
