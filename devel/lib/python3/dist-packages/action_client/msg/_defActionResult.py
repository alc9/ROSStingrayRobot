...
"""autogenerated by genpy from action_client/defActionResult.msg. Do not edit."""
import codecs
import sys
...
class defActionResult(genpy.Message):
  _md5sum = "00323d8843cc8ecf46b62007dd944d95"
  _type = "action_client/defActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_client/defResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(defActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = action_client.msg.defResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = action_client.msg.defResult()
