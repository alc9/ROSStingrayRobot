...
(cl:defmethod cl:initialize-instance :after ((m <defGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'defGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name safety_action_client-msg:<defGoal> is deprecated: use safety_action_client-msg:defGoal instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <defGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader safety_action_client-msg:x-val is deprecated.  Use safety_action_client-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <defGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader safety_action_client-msg:y-val is deprecated.  Use safety_action_client-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <defGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader safety_action_client-msg:z-val is deprecated.  Use safety_action_client-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <defGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader safety_action_client-msg:id-val is deprecated.  Use safety_action_client-msg:id instead.")
  (id m))
